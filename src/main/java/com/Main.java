...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Album album2 = new Album("album2", "description", Set.of());
        Album album3 = new Album("album3", "description", Set.of(photo3, photo4, photo5));
        ...
        user1.likePhoto(photo3);
        user1.likePhoto(photo4);
        user1.printLikes();

        user1.unlikePhoto(photo3);
